    ...
    internal class M_Users
    {
            ...
            try
            {
                if (await Apps.Query.Open())
                {
                    ...
                    if (await Apps.Query.insertPrepared(
                               schema.table["usedb"],
                                new MySqlParameter($"@{schema.usedb["NomUser"]}", args["NomUser"]),
                                new MySqlParameter($"@{schema.usedb["UserPass"]}", args["UserPass"])
                            ))
                    {
            ...
            try
            {
                if (await Apps.Query.Open())
                {
                    ...
                    if (await Apps.Query.updatePrepared(
                             schema.table["usedb"],
                                new MySqlParameter($"@{schema.usedb["compteUser"]}", args["compteUser"]),
                                new MySqlParameter($"@{schema.usedb["NomUser"]}", args["NomUser"])
                            ))
                    {
                        callback = new Dictionary<string, string> {
        ...
        public async void reseach(string param)
        {
            ...
            try
            {
                ...
                {
                    Apps.Schema schema = new Apps.Schema();
                    Apps.Query.getData($"select * from {schema.table["usedb"]} where {schema.usedb["NomUser"]} like '%{param}%' order by {schema.usedb["compteUser"]} DESC;");
                    callback = new Dictionary<string, string> {
        ...
        public async void get()
        {
            try
            {
                ...
                {
                    Apps.Schema schema = new Apps.Schema();
                    Apps.Query.getData($"select * from {schema.table["usedb"]}");
                    callback = new Dictionary<string, string> {
                        { "type", "success" }, { "message", "Collecte des données sans soucies" }
                    };
                }
        ...
        public async void connexionUser(string username, string password)
        {
            ...
            try
            {
                ...
                {
                    Apps.Schema schema = new Apps.Schema();
                    Apps.Query.getData($"select * from {schema.table["usedb"]} where {schema.usedb["NomUser"]}='{username}' && {schema.usedb["UserPass"]}='{password}'");
                    callback = new Dictionary<string, string> {
                        { "type", "success" }, { "message", "Collecte des données sans soucies" }
                    };
                }
        ...
        public async void reseachSession(string param)
        {
            ...
            try
            {
                ...
                {
                    Apps.Schema schema = new Apps.Schema();
                    Apps.Query.getData($"select * from {schema.table["usedb"]} where {schema.usedb["compteUser"]}='{param}'");
                    callback = new Dictionary<string, string> {
                        { "type", "success" }, { "message", "Collecte des données sans soucies" }
                    };
                }
